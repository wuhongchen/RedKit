...
**一句话描述**：一个基于油猴脚本的小红书网页端数据提取、评论爬取与素材打包工具。

**目标**：为运营人员提供高效、轻量的数据采集手段，支持笔记详情、全量评论导出及高清素材的一键打包下载。
...
**业务规则**：
- 仅在笔记详情页激活。
- 包含四个核心操作：提取笔记、提取评论、导出 CSV、下载素材。
...
### 进阶分析 (AI 增强)
- **爆款基因分析**：调用 LLM (Groq/OpenAI) 对笔记钩子、情绪价值和运营套路进行萃取。
- **自动建议**：根据同类爆款数据提供内容改写建议。
...
**文档版本**：v1.1.0 (Align with Code v1.2)
**最后更新**：2026-02-12
